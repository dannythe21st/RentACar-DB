...
public interface List<E> extends Serializable
{
     ...
     */
    E get( int position ) throws dataStructures.Dictionary_Entry.InvalidPositionException;
     ...
     * @throws dataStructures.Dictionary_Entry.InvalidPositionException - if position is not valid in the list
     */
    void add( int position, E element ) throws dataStructures.Dictionary_Entry.InvalidPositionException;
     ...
     * @throws dataStructures.Dictionary_Entry.InvalidPositionException - if position is not valid in the list
     */
    E remove( int position ) throws dataStructures.Dictionary_Entry.InvalidPositionException;
